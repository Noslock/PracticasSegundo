...
class fExploracion_t{
    public:
        // virtual int operator() (const CLAVE& c, int i) = 0;
...
class fExploracion_lineal_t : public fExploracion_t<CLAVE>{
    ...
    public:
        ...
        // int operator()(const CLAVE& c, int i){
...
class fExploracion_cuadratica_t : public fExploracion_t<CLAVE>{
    ...
    public:
        ...
        // int exploracion_2(const CLAVE& c, int i){
        //     int aux = h_ -> dispersion(c);
        //     return ((aux-(i*i)) % nCeldas); // no sé como controlar esto
        // }
};
